...
public class CreateReservationCommand extends CommandTemplate<Order>
{
	...
	public String createMessage(boolean undo) {
		...
		return String.format("{\"query\":\"mutation{%s(input:{arrivalDate: \\\"%s\\\" departureDate: \\\"%s\\\" numberOfOccupants: %d}){id arrivalDate departureDate rooms{id type name perks numberOfBeds rate}}}\"}", MUTATION_NAME, reservationOrder.getStartDate(), reservationOrder.getEndDate(), reservationOrder.getNumberOfOccupants());
	}
